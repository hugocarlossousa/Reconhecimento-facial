...
import mediapipe as mp # importa o mediapipe
...
while webcam.isOpened():
    ...
    if lista_rostos.detections: # caso algum rosto tenha sido reconhecido
        ...
        cv2.putText(frame, "Hugo! Meio dia vamos almocar",(5,50),cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,255),2,cv2.LINE_AA)     
...
cv2.destroyAllWindows() # fecha a janela que mostra o que a webcam está vendo.py…]()
